...
public final class MissionsFailStateViewHolder extends SelfInflatingViewHolder {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MissionsFailStateViewHolder(kzb kzbVar) {
        super(kzbVar, R.layout.item_loyalty_mission_fail_state);
