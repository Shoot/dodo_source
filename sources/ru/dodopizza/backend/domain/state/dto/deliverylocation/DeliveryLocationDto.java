...
public final class DeliveryLocationDto {
    ...
    public DeliveryLocationDto(String str, Map<String, String> map, CoordinatesDto coordinatesDto, String str2) {
    ...
    public static /* synthetic */ DeliveryLocationDto copy$default(DeliveryLocationDto deliveryLocationDto, String str, Map map, CoordinatesDto coordinatesDto, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = deliveryLocationDto.formattedAddress;
        }
        if ((i & 2) != 0) {
            map = deliveryLocationDto.additions;
        }
        if ((i & 4) != 0) {
            coordinatesDto = deliveryLocationDto.coordinates;
        }
        if ((i & 8) != 0) {
            str2 = deliveryLocationDto.encodedComponents;
        }
        return deliveryLocationDto.copy(str, map, coordinatesDto, str2);
    }
    ...
    public final DeliveryLocationDto copy(String str, Map<String, String> map, CoordinatesDto coordinatesDto, String str2) {
        z65.h(str, "formattedAddress");
        z65.h(coordinatesDto, MessageAttributes.COORDINATES);
        z65.h(str2, "encodedComponents");
        return new DeliveryLocationDto(str, map, coordinatesDto, str2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (z65.c(this.formattedAddress, deliveryLocationDto.formattedAddress) && z65.c(this.additions, deliveryLocationDto.additions) && z65.c(this.coordinates, deliveryLocationDto.coordinates) && z65.c(this.encodedComponents, deliveryLocationDto.encodedComponents)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "DeliveryLocationDto(formattedAddress=" + str + ", additions=" + map + ", coordinates=" + coordinatesDto + ", encodedComponents=" + str2 + ")";
    }
}
