...
public class b1<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    private final int a;
    private List<b1<K, V>.e> b;
    private Map<K, V> c;
    private boolean d;
    private volatile b1<K, V>.g e;
    private Map<K, V> f;
    private volatile b1<K, V>.c g;
    ...
    /* compiled from: SmallSortedMap.java */
    /* loaded from: classes2.dex */
    private class c extends b1<K, V>.g {
        private c() {
            super(b1.this, null);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.b1.g, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
    ...
    /* compiled from: SmallSortedMap.java */
    /* loaded from: classes2.dex */
    public class e implements Map.Entry<K, V>, Comparable<b1<K, V>.e> {
        private final K a;
        private V b;
        ...
        /* renamed from: a */
        public int compareTo(b1<K, V>.e eVar) {
    ...
    private class f implements Iterator<Map.Entry<K, V>> {
        ...
        private Iterator<Map.Entry<K, V>> a() {
            if (this.c == null) {
                this.c = b1.this.c.entrySet().iterator();
            }
            return this.c;
        }
        ...
        public Map.Entry<K, V> next() {
            ...
            this.a = i;
            if (i < b1.this.b.size()) {
                return (Map.Entry) b1.this.b.get(this.a);
            }
            return a().next();
        }
        ...
        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.a + 1 < b1.this.b.size()) {
                return true;
            }
            if (!b1.this.c.isEmpty() && a().hasNext()) {
                return true;
            }
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <FieldDescriptorType extends t.b<FieldDescriptorType>> b1<FieldDescriptorType, Object> s(int i) {
        return new a(i);
    }
    ...
    public V put(K k, V v) {
        ...
        int i2 = this.a;
        if (size == i2) {
            b1<K, V>.e remove = this.b.remove(i2 - 1);
    ...
    private class b implements Iterator<Map.Entry<K, V>> {
        ...
        private b() {
            this.a = b1.this.b.size();
        }

        private Iterator<Map.Entry<K, V>> a() {
            if (this.b == null) {
                this.b = b1.this.f.entrySet().iterator();
            }
            return this.b;
        }
        ...
        public boolean hasNext() {
            int i = this.a;
            if ((i > 0 && i <= b1.this.b.size()) || a().hasNext()) {
                return true;
            }
            return false;
        }
