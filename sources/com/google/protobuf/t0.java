...
public final class t0<E> extends c<E> implements RandomAccess {
    private static final t0<Object> d;
    private E[] b;
    private int c;

    static {
        t0<Object> t0Var = new t0<>(new Object[0], 0);
        d = t0Var;
        t0Var.l();
    }

    private t0(E[] eArr, int i) {
        this.b = eArr;
        this.c = i;
    }
    ...
    public t0<E> i(int i) {
        if (i >= this.c) {
            return new t0<>(Arrays.copyOf(this.b, i), this.c);
        }
