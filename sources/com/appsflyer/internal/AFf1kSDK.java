...
public final class AFf1kSDK {
    ...
    static {
        ...
        for (int i5 = 0; i5 < 256; i5++) {
            ...
            AFKeystoreWrapper[i6] = (i11 >>> 16) | (i11 << 16);
    ...
    public static int[] values(byte[] bArr, int i) throws IllegalArgumentException {
        ...
        if (bArr.length == 16) {
            ...
            for (int i6 = 0; i6 < 4; i6++) {
                int i7 = ((bArr[i5 + 1] & 255) << 16) | (bArr[i5] << 24);
                int i8 = i5 + 3;
                i5 += 4;
            ...
            while (i9 < i4) {
                ...
                if (i10 == 0) {
                    ...
                    i12 = ((bArr2[i12 >>> 24] & 255) | (((bArr2[(i12 >>> 16) & 255] << 24) | ((bArr2[(i12 >>> 8) & 255] & 255) << 16)) | ((bArr2[i12 & 255] & 255) << 8))) ^ afInfoLog[i11];
                    i11++;
                    i10 = 4;
                }
