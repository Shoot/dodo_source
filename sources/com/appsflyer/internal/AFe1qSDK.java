...
public final class AFe1qSDK extends AFd1tSDK<Void> {
    ...
    public AFe1qSDK(AFd1iSDK aFd1iSDK, AFb1gSDK aFb1gSDK) {
        ...
        this.afRDLog = ((AFd1kSDK) aFd1iSDK).afDebugLog;
    ...
    public final AFc1aSDK AFInAppEventParameterName() throws Exception {
        ...
        long valueOf = this.AFLogger.valueOf("appsflyerConversionDataCacheExpiration", 0L);
        if (valueOf != 0 && System.currentTimeMillis() - valueOf > 5184000000L) {
            ...
            this.AFLogger.AFInAppEventType("appsflyerConversionDataCacheExpiration", 0L);
        }
        Map<String, Object> afErrorLog = afErrorLog();
        if (afErrorLog != null) {
            try {
                if (!afErrorLog.containsKey("is_first_launch")) {
                    afErrorLog.put("is_first_launch", Boolean.FALSE);
                }
                AFe1tSDK.AFInAppEventParameterName(afErrorLog);
            } catch (Exception e) {
