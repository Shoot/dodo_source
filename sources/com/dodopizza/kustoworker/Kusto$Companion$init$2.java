...
final class Kusto$Companion$init$2 extends ej5 implements Function1<InitializedKusto, Unit> {
    public static final Kusto$Companion$init$2 INSTANCE = new Kusto$Companion$init$2();

    Kusto$Companion$init$2() {
        super(1);
    }
