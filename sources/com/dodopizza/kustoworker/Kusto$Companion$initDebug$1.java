...
final class Kusto$Companion$initDebug$1 extends ej5 implements Function1<InitializedKusto, Unit> {
    public static final Kusto$Companion$initDebug$1 INSTANCE = new Kusto$Companion$initDebug$1();

    Kusto$Companion$initDebug$1() {
        super(1);
    }
