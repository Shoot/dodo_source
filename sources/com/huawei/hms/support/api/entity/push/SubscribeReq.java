...
public class SubscribeReq implements IMessageEntity {
    ...
    public String toString() {
        return "SubscribeReq{packageName='" + this.packageName + CoreConstants.SINGLE_QUOTE_CHAR + ", operation='" + this.operation + CoreConstants.SINGLE_QUOTE_CHAR + CoreConstants.CURLY_RIGHT;
    }
