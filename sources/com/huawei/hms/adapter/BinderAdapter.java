...
public class BinderAdapter implements ServiceConnection {
    ...
    private void delayedUnbind() {
        ...
        handler.sendEmptyMessageDelayed(getMsgDelayDisconnect(), ComponentTracker.DEFAULT_TIMEOUT);
    }
    ...
    private void postConnDelayHandle() {
        ...
        this.mBinderTimeoutHandler.sendEmptyMessageDelayed(getConnTimeOut(), AbstractComponentTracker.LINGERING_TIMEOUT);
    }
    ...
    public void updateDelayTask() {
        ...
        synchronized (BinderAdapter.class) {
            try {
                ...
                if (handler != null) {
                    handler.removeMessages(getMsgDelayDisconnect());
                    this.delayDisconnectHandler.sendEmptyMessageDelayed(getMsgDelayDisconnect(), ComponentTracker.DEFAULT_TIMEOUT);
                }
            } catch (Throwable th) {
                throw th;
            }
