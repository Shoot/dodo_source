...
public class n {
    ...
    public static String c(Context context, String str, String str2) {
        try {
            ...
            jSONObject2.put(tmb.c.COUNTRY_JSON_NAME, SystemUtils.getLocalCountry());
            ...
            jSONObject.put(HiAnalyticsConstant.BI_KEY_APP_ID, z.d(context).a("client/app_id"));
            jSONObject.put(tmb.f.REGION_JSON_NAME, z.d(context).a(tmb.f.REGION_JSON_NAME));
