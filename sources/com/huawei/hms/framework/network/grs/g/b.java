...
public class b {
    ...
    public String a(boolean z) {
        String str;
        String str2 = com.huawei.hms.framework.network.grs.a.a(this.c.a().a("geoipCountryCode", ""), "geoip.countrycode").get(Logger.ROOT_LOGGER_NAME);
        ...
        if (TextUtils.isEmpty(str2) || com.huawei.hms.framework.network.grs.h.e.a(Long.valueOf(j))) {
            ...
            if (z) {
                ...
                if (a2 != null) {
                    str2 = com.huawei.hms.framework.network.grs.a.a(a2.j(), "geoip.countrycode").get(Logger.ROOT_LOGGER_NAME);
                }
