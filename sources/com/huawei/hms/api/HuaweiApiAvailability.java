...
public abstract class HuaweiApiAvailability {
    ...
    public abstract v6b<Void> checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr);

    public abstract v6b<Void> checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr);
    ...
    public abstract v6b<Void> getHuaweiServicesReady(Activity activity);
