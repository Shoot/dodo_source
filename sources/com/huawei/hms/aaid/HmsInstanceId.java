...
public class HmsInstanceId {
    ...
    public v6b<AAIDResult> getAAID() {
        try {
            return n7b.b(new j(this.a.getApplicationContext()));
        } catch (Exception unused) {
            z6b z6bVar = new z6b();
            z6bVar.b(ErrorEnum.ERROR_INTERNAL_ERROR.toApiException());
            return z6bVar.a();
        }
    }
    ...
    public final String a(TokenReq tokenReq, int i) throws ApiException {
        ...
        try {
            ...
            lVar.setApiLevel(i);
            return ((TokenResult) n7b.a(this.c.doWrite(lVar))).getToken();
        } catch (Exception e) {
