...
public final class ThreadsGateTransport$special$$inlined$inject$7 extends ej5 implements Function0<ClientUseCase> {
    public static final ThreadsGateTransport$special$$inlined$inject$7 INSTANCE = new ThreadsGateTransport$special$$inlined$inject$7();

    public ThreadsGateTransport$special$$inlined$inject$7() {
        super(0);
    }
