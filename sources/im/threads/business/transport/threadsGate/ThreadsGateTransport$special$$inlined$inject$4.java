...
public final class ThreadsGateTransport$special$$inlined$inject$4 extends ej5 implements Function0<ChatUpdateProcessor> {
    public static final ThreadsGateTransport$special$$inlined$inject$4 INSTANCE = new ThreadsGateTransport$special$$inlined$inject$4();

    public ThreadsGateTransport$special$$inlined$inject$4() {
        super(0);
    }
