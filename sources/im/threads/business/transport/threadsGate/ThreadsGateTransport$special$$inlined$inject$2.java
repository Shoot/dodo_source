...
public final class ThreadsGateTransport$special$$inlined$inject$2 extends ej5 implements Function0<Preferences> {
    public static final ThreadsGateTransport$special$$inlined$inject$2 INSTANCE = new ThreadsGateTransport$special$$inlined$inject$2();

    public ThreadsGateTransport$special$$inlined$inject$2() {
        super(0);
    }
