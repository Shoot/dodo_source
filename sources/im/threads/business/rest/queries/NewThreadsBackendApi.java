...
public interface NewThreadsBackendApi {
    ...
    public static final class DefaultImpls {
        public static /* synthetic */ Call history$default(NewThreadsBackendApi newThreadsBackendApi, Map map, String str, String str2, Integer num, String str3, String str4, int i, Object obj) {
            if (obj == null) {
                if ((i & 32) != 0) {
                    str4 = ThreadsApi.Companion.getApiVersion();
                }
        ...
        public static /* synthetic */ Call search$default(NewThreadsBackendApi newThreadsBackendApi, Map map, String str, int i, String str2, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 8) != 0) {
                    str2 = ThreadsApi.Companion.getApiVersion();
                }
                return newThreadsBackendApi.search(map, str, i, str2);
            }
