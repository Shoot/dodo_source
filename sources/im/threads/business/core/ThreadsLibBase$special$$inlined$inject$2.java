...
public final class ThreadsLibBase$special$$inlined$inject$2 extends ej5 implements Function0<ClientUseCase> {
    public static final ThreadsLibBase$special$$inlined$inject$2 INSTANCE = new ThreadsLibBase$special$$inlined$inject$2();

    public ThreadsLibBase$special$$inlined$inject$2() {
        super(0);
    }
