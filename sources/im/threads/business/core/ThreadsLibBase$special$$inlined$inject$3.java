...
public final class ThreadsLibBase$special$$inlined$inject$3 extends ej5 implements Function0<ChatUpdateProcessor> {
    public static final ThreadsLibBase$special$$inlined$inject$3 INSTANCE = new ThreadsLibBase$special$$inlined$inject$3();

    public ThreadsLibBase$special$$inlined$inject$3() {
        super(0);
    }
