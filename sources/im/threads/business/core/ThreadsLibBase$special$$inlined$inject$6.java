...
public final class ThreadsLibBase$special$$inlined$inject$6 extends ej5 implements Function0<ClientUseCase> {
    public static final ThreadsLibBase$special$$inlined$inject$6 INSTANCE = new ThreadsLibBase$special$$inlined$inject$6();

    public ThreadsLibBase$special$$inlined$inject$6() {
        super(0);
    }
