...
public final class ThreadsLibBase$special$$inlined$inject$1 extends ej5 implements Function0<Preferences> {
    public static final ThreadsLibBase$special$$inlined$inject$1 INSTANCE = new ThreadsLibBase$special$$inlined$inject$1();

    public ThreadsLibBase$special$$inlined$inject$1() {
        super(0);
    }
