...
public final class FilePosterKt$sendFile$$inlined$inject$1 extends ej5 implements Function0<ChatUpdateProcessor> {
    public static final FilePosterKt$sendFile$$inlined$inject$1 INSTANCE = new FilePosterKt$sendFile$$inlined$inject$1();

    public FilePosterKt$sendFile$$inlined$inject$1() {
        super(0);
    }
