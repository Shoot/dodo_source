...
final class MessengerImpl$removeUserMessageFromQueue$2 extends ej5 implements Function1<UserPhrase, Boolean> {
    final /* synthetic */ UserPhrase $userPhrase;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MessengerImpl$removeUserMessageFromQueue$2(UserPhrase userPhrase) {
        super(1);
