...
public final class MessengerImpl$special$$inlined$inject$1 extends ej5 implements Function0<NetworkInteractor> {
    ...
    public final NetworkInteractor invoke() {
        Object serviceType = ServiceLocatorApiKt.getServiceLocator().resolveInstance(bc9.b(NetworkInteractor.class)).getInstance();
        if (serviceType != null) {
            return (NetworkInteractor) serviceType;
        }
        throw new NullPointerException("null cannot be cast to non-null type im.threads.business.utils.internet.NetworkInteractor");
    }
}
