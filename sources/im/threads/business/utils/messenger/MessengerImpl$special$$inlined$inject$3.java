...
public final class MessengerImpl$special$$inlined$inject$3 extends ej5 implements Function0<Preferences> {
    public static final MessengerImpl$special$$inlined$inject$3 INSTANCE = new MessengerImpl$special$$inlined$inject$3();

    public MessengerImpl$special$$inlined$inject$3() {
        super(0);
    }
