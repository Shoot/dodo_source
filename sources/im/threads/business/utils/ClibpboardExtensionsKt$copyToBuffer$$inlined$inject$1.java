...
public final class ClibpboardExtensionsKt$copyToBuffer$$inlined$inject$1 extends ej5 implements Function0<Preferences> {
    public static final ClibpboardExtensionsKt$copyToBuffer$$inlined$inject$1 INSTANCE = new ClibpboardExtensionsKt$copyToBuffer$$inlined$inject$1();

    public ClibpboardExtensionsKt$copyToBuffer$$inlined$inject$1() {
        super(0);
    }
