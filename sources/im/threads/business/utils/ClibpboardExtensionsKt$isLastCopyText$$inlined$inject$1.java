...
public final class ClibpboardExtensionsKt$isLastCopyText$$inlined$inject$1 extends ej5 implements Function0<Preferences> {
    public static final ClibpboardExtensionsKt$isLastCopyText$$inlined$inject$1 INSTANCE = new ClibpboardExtensionsKt$isLastCopyText$$inlined$inject$1();

    public ClibpboardExtensionsKt$isLastCopyText$$inlined$inject$1() {
        super(0);
    }
