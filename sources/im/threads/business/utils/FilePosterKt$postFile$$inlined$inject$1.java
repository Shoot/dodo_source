...
public final class FilePosterKt$postFile$$inlined$inject$1 extends ej5 implements Function0<ChatUpdateProcessor> {
    public static final FilePosterKt$postFile$$inlined$inject$1 INSTANCE = new FilePosterKt$postFile$$inlined$inject$1();

    public FilePosterKt$postFile$$inlined$inject$1() {
        super(0);
    }
