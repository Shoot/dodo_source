...
public final class FileDownloader$special$$inlined$inject$1 extends ej5 implements Function0<ClientUseCase> {
    public static final FileDownloader$special$$inlined$inject$1 INSTANCE = new FileDownloader$special$$inlined$inject$1();

    public FileDownloader$special$$inlined$inject$1() {
        super(0);
    }
