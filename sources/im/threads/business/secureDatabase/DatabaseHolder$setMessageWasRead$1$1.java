...
public final class DatabaseHolder$setMessageWasRead$1$1 extends ej5 implements Function0<Unit> {
    final /* synthetic */ String $it;
    final /* synthetic */ DatabaseHolder this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DatabaseHolder$setMessageWasRead$1$1(DatabaseHolder databaseHolder, String str) {
        super(0);
    ...
    public final void invoke2() {
        ...
        ((ThreadsDbHelper) mutableLazy.getValue()).setMessageWasRead(this.$it);
    }
}
