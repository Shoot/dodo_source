...
public final class DatabaseHolder$getChatItemByCorrelationId$1 extends ej5 implements Function0<ChatItem> {
    final /* synthetic */ String $messageUuid;
    final /* synthetic */ DatabaseHolder this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DatabaseHolder$getChatItemByCorrelationId$1(DatabaseHolder databaseHolder, String str) {
        super(0);
    ...
    public final ChatItem invoke() {
        ...
        return ((ThreadsDbHelper) mutableLazy.getValue()).getChatItemByCorrelationId(this.$messageUuid);
    }
}
