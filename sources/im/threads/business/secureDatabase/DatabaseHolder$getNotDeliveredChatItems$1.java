...
public final class DatabaseHolder$getNotDeliveredChatItems$1 extends ej5 implements Function0<List<? extends UserPhrase>> {
    final /* synthetic */ DatabaseHolder this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DatabaseHolder$getNotDeliveredChatItems$1(DatabaseHolder databaseHolder) {
        super(0);
    ...
    public final List<? extends UserPhrase> invoke() {
        ...
        return ((ThreadsDbHelper) mutableLazy.getValue()).getNotDeliveredChatItems();
    }
}
