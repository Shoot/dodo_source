...
@Metadata(d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u0004\u0018\u00010\u0001H\n¢\u0006\u0002\b\u0002"}, d2 = {"<anonymous>", "Lim/threads/business/models/ConsultInfo;", "invoke"}, k = 3, mv = {1, 8, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class DatabaseHolder$getConsultInfo$1 extends ej5 implements Function0<ConsultInfo> {
    ...
    public final ConsultInfo invoke() {
        ...
        return ((ThreadsDbHelper) mutableLazy.getValue()).getLastConsultInfo(this.$id);
    }
}
