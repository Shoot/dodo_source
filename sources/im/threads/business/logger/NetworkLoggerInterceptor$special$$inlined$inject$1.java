...
public final class NetworkLoggerInterceptor$special$$inlined$inject$1 extends ej5 implements Function0<JsonFormatter> {
    public static final NetworkLoggerInterceptor$special$$inlined$inject$1 INSTANCE = new NetworkLoggerInterceptor$special$$inlined$inject$1();

    public NetworkLoggerInterceptor$special$$inlined$inject$1() {
        super(0);
    }
