...
public final class ThreadsLib$config$2 extends ej5 implements Function0<Config> {
    public static final ThreadsLib$config$2 INSTANCE = new ThreadsLib$config$2();
