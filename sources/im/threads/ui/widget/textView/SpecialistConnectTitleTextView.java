...
public final class SpecialistConnectTitleTextView extends CustomFontTextView {
    ...
    public void setTypefaceView(Context context) {
        ...
        if (!TextUtils.isEmpty(chatStyle.specialistConnectTitleFont)) {
            setTypeface(Typeface.createFromAsset(context.getAssets(), chatStyle.specialistConnectTitleFont));
        } else {
            super.setTypefaceView(context);
        }
    }

    public SpecialistConnectTitleTextView(Context context, AttributeSet attributeSet) {
