...
public final class ScheduleAlertTextView extends CustomFontTextView {
    ...
    public void setTypefaceView(Context context) {
        ...
        if (!TextUtils.isEmpty(chatStyle.scheduleAlertFont)) {
            setTypeface(Typeface.createFromAsset(context.getAssets(), chatStyle.scheduleAlertFont));
        } else {
            super.setTypefaceView(context);
        }
    }

    public ScheduleAlertTextView(Context context, AttributeSet attributeSet) {
