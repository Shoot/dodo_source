...
public final class Config$special$$inlined$inject$1 extends ej5 implements Function0<StyleUseCase> {
    public static final Config$special$$inlined$inject$1 INSTANCE = new Config$special$$inlined$inject$1();

    public Config$special$$inlined$inject$1() {
        super(0);
    }
