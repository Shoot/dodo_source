...
public final class FileHelper$special$$inlined$inject$1 extends ej5 implements Function0<ChatUpdateProcessor> {
    public static final FileHelper$special$$inlined$inject$1 INSTANCE = new FileHelper$special$$inlined$inject$1();

    public FileHelper$special$$inlined$inject$1() {
        super(0);
    }
