...
public final class ShimmerGroup$addView$1 extends ej5 implements Function1<WeakReference<ShimmerLayout>, Boolean> {
    final /* synthetic */ ShimmerLayout $shimmerLayout;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShimmerGroup$addView$1(ShimmerLayout shimmerLayout) {
        super(1);
