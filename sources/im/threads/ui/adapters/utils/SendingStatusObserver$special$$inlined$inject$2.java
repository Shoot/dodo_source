...
public final class SendingStatusObserver$special$$inlined$inject$2 extends ej5 implements Function0<ChatUpdateProcessor> {
    public static final SendingStatusObserver$special$$inlined$inject$2 INSTANCE = new SendingStatusObserver$special$$inlined$inject$2();

    public SendingStatusObserver$special$$inlined$inject$2() {
        super(0);
    }
