...
public final class ChatController$special$$inlined$inject$1 extends ej5 implements Function0<ChatUpdateProcessor> {
    public static final ChatController$special$$inlined$inject$1 INSTANCE = new ChatController$special$$inlined$inject$1();

    public ChatController$special$$inlined$inject$1() {
        super(0);
    }
