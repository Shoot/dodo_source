...
public final class ChatController$subscribeToMessageSendError$2 extends ej5 implements Function1<ChatItem, Unit> {
    final /* synthetic */ ChatController this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChatController$subscribeToMessageSendError$2(ChatController chatController) {
        super(1);
    ...
    public final void invoke2(ChatItem chatItem) {
        ...
        if (chatItem instanceof UserPhrase) {
            ...
            messenger.addMsgToResendQueue(userPhrase2);
            messenger2 = this.this$0.messenger;
            messenger2.proceedSendingQueue(userPhrase2);
        }
    }
}
