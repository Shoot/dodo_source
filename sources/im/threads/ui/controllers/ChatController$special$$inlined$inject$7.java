...
public final class ChatController$special$$inlined$inject$7 extends ej5 implements Function0<ClientUseCase> {
    public static final ChatController$special$$inlined$inject$7 INSTANCE = new ChatController$special$$inlined$inject$7();

    public ChatController$special$$inlined$inject$7() {
        super(0);
    }
