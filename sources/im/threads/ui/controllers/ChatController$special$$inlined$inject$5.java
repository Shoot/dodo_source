...
public final class ChatController$special$$inlined$inject$5 extends ej5 implements Function0<Preferences> {
    public static final ChatController$special$$inlined$inject$5 INSTANCE = new ChatController$special$$inlined$inject$5();

    public ChatController$special$$inlined$inject$5() {
        super(0);
    }
