...
public final class ChatController$special$$inlined$inject$3 extends ej5 implements Function0<ConsultWriter> {
    ...
    public final ConsultWriter invoke() {
        Object serviceType = ServiceLocatorApiKt.getServiceLocator().resolveInstance(bc9.b(ConsultWriter.class)).getInstance();
        if (serviceType != null) {
            return (ConsultWriter) serviceType;
        }
        throw new NullPointerException("null cannot be cast to non-null type im.threads.business.utils.ConsultWriter");
    }
}
