...
public class DH {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("KeyAgreement", co7.N2, "org.bouncycastle.jcajce.provider.asymmetric.dh.KeyAgreementSpi$DHwithRFC2631KDF");
            configurableProvider.addAlgorithm("KeyAgreement", co7.O2, "org.bouncycastle.jcajce.provider.asymmetric.dh.KeyAgreementSpi$DHwithRFC2631KDF");
            ...
            registerOid(configurableProvider, co7.l0, "DH", new KeyFactorySpi());
            registerOid(configurableProvider, oac.t4, "DH", new KeyFactorySpi());
        }
    }
