...
public class SignatureSpi extends java.security.SignatureSpi implements co7, aac {
    ...
    protected void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        ux generatePrivateKeyParameter = privateKey instanceof ua3 ? ECUtil.generatePrivateKeyParameter(privateKey) : GOST3410Util.generatePrivateKeyParameter(privateKey);
        this.digest.reset();
    ...
    protected void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (publicKey instanceof pb3) {
            ...
            try {
                PublicKey e = ff0.e(b1b.u(publicKey.getEncoded()));
                if (e instanceof pb3) {
                    generatePublicKeyParameter = ECUtil.generatePublicKeyParameter(e);
                } else {
