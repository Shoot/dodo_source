...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    private void init(hb4 hb4Var, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        ...
        iac e2 = pa3.e(e);
        if (e2 != null) {
            this.ecParams = new fb3(pa3.f(e), e2.t(), e2.u(), e2.x(), e2.v(), e2.z());
            va3 va3Var = new va3(new qa3(new hb3(e, e2), e, hb4Var.b(), hb4Var.c()), secureRandom);
            this.param = va3Var;
    ...
    public KeyPair generateKeyPair() {
        if (this.initialised) {
            ...
            if (obj instanceof ib3) {
                ib3 ib3Var = (ib3) obj;
                BCECGOST3410PublicKey bCECGOST3410PublicKey = new BCECGOST3410PublicKey(this.algorithm, qb3Var, ib3Var);
                return new KeyPair(bCECGOST3410PublicKey, new BCECGOST3410PrivateKey(this.algorithm, nb3Var, bCECGOST3410PublicKey, ib3Var));
            } else if (obj == null) {
                return new KeyPair(new BCECGOST3410PublicKey(this.algorithm, qb3Var), new BCECGOST3410PrivateKey(this.algorithm, nb3Var));
            } else {
                ECParameterSpec eCParameterSpec = (ECParameterSpec) obj;
                BCECGOST3410PublicKey bCECGOST3410PublicKey2 = new BCECGOST3410PublicKey(this.algorithm, qb3Var, eCParameterSpec);
                return new KeyPair(bCECGOST3410PublicKey2, new BCECGOST3410PrivateKey(this.algorithm, nb3Var, bCECGOST3410PublicKey2, eCParameterSpec));
            }
        }
