...
public class PatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        hashMap.put(DateTokenConverter.CONVERTER_KEY, DateConverter.class.getName());
        ...
        hashMap.put(c.a, LoggerConverter.class.getName());
        hashMap.put(Image.TYPE_MEDIUM, MessageConverter.class.getName());
        hashMap.put(RemoteMessageConst.MessageBody.MSG, MessageConverter.class.getName());
