...
public class StatusUtil {
    ...
    public static boolean contextHasStatusListener(Context context) {
        ...
        if (statusManager == null || (copyOfStatusListenerList = statusManager.getCopyOfStatusListenerList()) == null || copyOfStatusListenerList.size() == 0) {
            return false;
        }
        return true;
    }
