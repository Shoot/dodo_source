...
public class RollingFileAppender<E> extends FileAppender<E> {
    ...
    private boolean checkForCollisionsInPreviousRollingFileAppenders() {
        ...
        if ((triggeringPolicy instanceof RollingPolicyBase) && innerCheckForFileNamePatternCollisionInPreviousRFA(((RollingPolicyBase) triggeringPolicy).fileNamePattern)) {
            return true;
        }
        return false;
    }
