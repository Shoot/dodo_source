    ...
    private FilenameFilter createExpiredFileFilter(final Date date) {
        return new FilenameFilter() { // from class: ch.qos.logback.core.rolling.helper.TimeBasedArchiveRemover.1
            ...
            public boolean accept(File file, String str) {
                if (TimeBasedArchiveRemover.this.rc.normalizeDate(TimeBasedArchiveRemover.this.dateParser.parseFilename(str)).compareTo(TimeBasedArchiveRemover.this.rc.normalizeDate(TimeBasedArchiveRemover.this.rc.getEndOfNextNthPeriod(date, -TimeBasedArchiveRemover.this.maxHistory))) < 0) {
                    return true;
                }
                return false;
            }
