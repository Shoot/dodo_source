...
public abstract class SMTPAppenderBase<E> extends AppenderBase<E> {
    ...
    private Session buildSessionFromProperties() {
        ...
        if (this.username != null) {
            ...
            properties.put("mail.smtp.auth", tmb.h.TRUE_JSON_NAME);
        } else {
        ...
        if (isSTARTTLS() && isSSL()) {
            ...
            if (isSTARTTLS()) {
                properties.put("mail.smtp.starttls.enable", tmb.h.TRUE_JSON_NAME);
                properties.put("mail.transport.protocol", tmb.h.TRUE_JSON_NAME);
            }
            if (isSSL()) {
                properties.put("mail.smtp.ssl.enable", tmb.h.TRUE_JSON_NAME);
            }
        }
