...
public class e0 {
    ...
    public static e0 t(Context context, int i, int[] iArr) {
    ...
    public static e0 v(Context context, AttributeSet attributeSet, int[] iArr, int i, int i2) {
    ...
    public ColorStateList c(int i) {
        int resourceId;
        ColorStateList a;
        if (this.b.hasValue(i) && (resourceId = this.b.getResourceId(i, 0)) != 0 && (a = on.a(this.a, resourceId)) != null) {
            return a;
        }
    ...
    public Typeface j(int i, int i2, ek9.e eVar) {
        ...
        return ek9.i(this.a, resourceId, this.c, i2, eVar);
    }
