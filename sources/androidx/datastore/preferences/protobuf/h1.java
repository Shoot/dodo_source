    ...
    static final class c extends b {
        ...
        */
        int b(java.lang.CharSequence r8, byte[] r9, int r10, int r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.h1.c.b(java.lang.CharSequence, byte[], int, int):int");
        }
        ...
        */
        int d(int r7, byte[] r8, int r9, int r10) {
            ...
            L1c:
                ...
                r9 = r8[r9]
                if (r7 < r10) goto L31
                int r7 = androidx.datastore.preferences.protobuf.h1.a(r0, r9)
                return r7
            L31:
                r5 = r9
                r9 = r7
            ...
            L49:
                ...
                r1 = r8[r9]
                if (r7 < r10) goto L5a
                int r7 = androidx.datastore.preferences.protobuf.h1.a(r0, r1)
                return r7
            L5a:
                r9 = 0
                goto L62
            ...
            L62:
                ...
                r7 = r8[r7]
                if (r9 < r10) goto L6f
                int r7 = androidx.datastore.preferences.protobuf.h1.b(r0, r1, r7)
                return r7
            L6f:
                r5 = r9
                r9 = r7
            ...
            L86:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.h1.c.d(int, byte[], int, int):int");
        }
    }
        ...
        */
        private static int f(byte[] r10, long r11, int r13) {
            ...
            L9:
                ...
                if (r13 <= 0) goto L1a
                long r4 = r11 + r2
                byte r1 = androidx.datastore.preferences.protobuf.g1.s(r10, r11)
                if (r1 < 0) goto L19
                int r13 = r13 + (-1)
                r11 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r11
                byte r11 = androidx.datastore.preferences.protobuf.g1.s(r10, r11)
                if (r11 <= r6) goto L37
                goto L39
            L37:
                r11 = r2
            ...
            L48:
                int r13 = r13 + (-3)
                long r2 = r2 + r11
                byte r0 = androidx.datastore.preferences.protobuf.g1.s(r10, r11)
                if (r0 > r6) goto L64
                r7 = -96
                if (r1 != r4) goto L57
                if (r0 < r7) goto L64
            ...
            L5d:
                long r11 = r11 + r8
                byte r0 = androidx.datastore.preferences.protobuf.g1.s(r10, r2)
                if (r0 <= r6) goto L7
            L64:
                return r5
            L65:
            ...
            L6d:
                ...
                r0 = 3
                long r11 = r11 + r0
                byte r0 = androidx.datastore.preferences.protobuf.g1.s(r10, r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.h1.e.f(byte[], long, int):int");
        }
        ...
        private static int h(byte[] bArr, int i, long j, int i2) {
            ...
            if (i2 == 1) {
                return h1.j(i, g1.s(bArr, j));
            }
            if (i2 == 2) {
                return h1.k(i, g1.s(bArr, j), g1.s(bArr, j + 1));
            }
                ...
                while (i < i3) {
                    ...
                    if (a.n(s2)) {
                        ...
                        if (i6 < i3 - 1) {
                            int i8 = i + 2;
                            i += 3;
                            a.j(s2, g1.s(bArr, i6), g1.s(bArr, i8), cArr, i5);
                            i5++;
                        } else {
                            throw InvalidProtocolBufferException.c();
                        }
                        ...
                        int i9 = i + 3;
                        i += 4;
                        a.h(s2, g1.s(bArr, i6), g1.s(bArr, i + 2), g1.s(bArr, i9), cArr, i5);
                        i5 += 2;
                    } else {
                        throw InvalidProtocolBufferException.c();
                    }
                ...
                while (i4 < length) {
                    ...
                    if (charAt2 < 128 && j4 < j5) {
                        ...
                        if (charAt2 < 2048 && j4 <= j5 - 2) {
                            ...
                            str2 = str4;
                            long j6 = j4 + j;
                            g1.H(bArr, j4, (byte) ((charAt2 >>> 6) | 960));
                            j4 += 2;
                            g1.H(bArr, j6, (byte) ((charAt2 & '?') | 128));
                        } else {
                            str = str3;
                            str2 = str4;
                            if ((charAt2 < 55296 || 57343 < charAt2) && j4 <= j5 - 3) {
                                g1.H(bArr, j4, (byte) ((charAt2 >>> '\f') | 480));
                                long j7 = j4 + 2;
                                g1.H(bArr, j4 + 1, (byte) (((charAt2 >>> 6) & 63) | 128));
                                j4 += 3;
                                g1.H(bArr, j7, (byte) ((charAt2 & '?') | 128));
                            } else if (j4 <= j5 - 4) {
                                int i5 = i4 + 1;
                                if (i5 != length) {
                                    ...
                                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                                        ...
                                        j2 = 1;
                                        g1.H(bArr, j4, (byte) ((codePoint >>> 18) | 240));
                                        j3 = j5;
                                        g1.H(bArr, j4 + 1, (byte) (((codePoint >>> 12) & 63) | 128));
                                        long j8 = j4 + 3;
                                        g1.H(bArr, j4 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                        j4 += 4;
                                        g1.H(bArr, j8, (byte) ((codePoint & 63) | 128));
                                        i4 = i5;
                                    } else {
                                        i4 = i5;
                                    }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0059, code lost:
            if (androidx.datastore.preferences.protobuf.g1.s(r13, r2) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
            if (androidx.datastore.preferences.protobuf.g1.s(r13, r2) > (-65)) goto L56;
         */
        @Override // androidx.datastore.preferences.protobuf.h1.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        int d(int r12, byte[] r13, int r14, int r15) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.h1.e.d(int, byte[], int, int):int");
        }
    }
