...
public interface w0 {
    ...
    void F(List<g> list) throws IOException;
    ...
    <T> T J(x0<T> x0Var, n nVar) throws IOException;

    <T> void K(List<T> list, x0<T> x0Var, n nVar) throws IOException;

    @Deprecated
    <T> T L(x0<T> x0Var, n nVar) throws IOException;
    ...
    @Deprecated
    <T> void P(List<T> list, x0<T> x0Var, n nVar) throws IOException;
