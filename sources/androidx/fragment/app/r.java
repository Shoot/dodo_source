...
class r extends s {
    ...
    private static boolean v(Transition transition) {
        if (s.i(transition.getTargetIds()) && s.i(transition.getTargetNames()) && s.i(transition.getTargetTypes())) {
            return false;
        }
        return true;
    }
    ...
    public void b(Object obj, ArrayList<View> arrayList) {
        ...
        } else if (!v(transition) && s.i(transition.getTargets())) {
    ...
    class c implements Transition.TransitionListener {
        ...
        public void onTransitionStart(Transition transition) {
            Object obj = this.a;
            if (obj != null) {
                r.this.w(obj, this.b, null);
            }
            Object obj2 = this.c;
            if (obj2 != null) {
                r.this.w(obj2, this.d, null);
            }
            Object obj3 = this.e;
            if (obj3 != null) {
                r.this.w(obj3, this.f, null);
            }
        }
