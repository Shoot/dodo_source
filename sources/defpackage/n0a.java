...
public class n0a extends ea3.b {
    ...
    class a extends g1 {
        ...
        private jb3 d(long[] jArr, long[] jArr2) {
            return n0a.this.i(new m0a(jArr), new m0a(jArr2), n0a.k);
        }
    ...
    public n0a() {
        super(113, 9, 0, 0);
        this.j = new o0a(this, null, null);
        this.b = m(new BigInteger(1, b.b("003088250CA6E7C7FE649CE85820F7")));
        this.c = m(new BigInteger(1, b.b("00E8BEE4D3E2260744188BE0E9C723")));
        this.d = new BigInteger(1, b.b("0100000000000000D9CCEC8A39E56F"));
    ...
    public jb3 h(na3 na3Var, na3 na3Var2) {
        return new o0a(this, na3Var, na3Var2);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // defpackage.ea3
    public jb3 i(na3 na3Var, na3 na3Var2, na3[] na3VarArr) {
        return new o0a(this, na3Var, na3Var2, na3VarArr);
    }
