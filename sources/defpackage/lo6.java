...
public class lo6 extends s32 {
    ...
    public lo6(double[] dArr, double[][] dArr2) {
    ...
    public static lo6 h(String str) {
        ...
        return i(Arrays.copyOf(dArr, i + 1));
    }

    private static lo6 i(double[] dArr) {
        ...
        while (i < length - 1) {
            ...
            if (d2 <= d3) {
                ...
                for (int i3 = 0; i3 < length2; i3++) {
                    ...
                    double[][] dArr5 = this.c;
                    dArr[i3] = j(d5, d6, d7, d8, dArr5[i][i3], dArr5[i2][i3]) / d5;
                }
                return;
            }
            i = i2;
    ...
    public double k(double d, int i) {
        ...
        while (i2 < length - 1) {
            ...
            if (d2 <= d3) {
                ...
                double[][] dArr4 = this.c;
                return j(d5, (d2 - d4) / d5, d6, d7, dArr4[i2][i], dArr4[i3][i]) / d5;
            }
            i2 = i3;
        }
        return 0.0d;
