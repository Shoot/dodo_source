...
public class cbc extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public final Key engineTranslateKey(Key key) throws InvalidKeyException {
        if (!(key instanceof k50) && !(key instanceof l50)) {
