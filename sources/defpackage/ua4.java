...
public class ua4 implements xc0 {
    ...
    private void c(int[] iArr, byte[] bArr, int i2, byte[] bArr2, int i3) {
        int i4;
        int i5;
        int f2 = f(bArr, i2);
        int f3 = f(bArr, i2 + 4);
        ...
        j(i5, bArr2, i3);
        j(d(i5, iArr[0]) ^ i4, bArr2, i3 + 4);
    }

    private int d(int i2, int i3) {
        int i4 = i3 + i2;
        byte[] bArr = this.c;
        int i5 = bArr[i4 & 15] + (bArr[((i4 >> 4) & 15) + 16] << 4) + (bArr[((i4 >> 8) & 15) + 32] << 8) + (bArr[((i4 >> 12) & 15) + 48] << 12) + (bArr[((i4 >> 16) & 15) + 64] << 16) + (bArr[((i4 >> 20) & 15) + 80] << 20) + (bArr[((i4 >> 24) & 15) + 96] << 24) + (bArr[((i4 >> 28) & 15) + 112] << 28);
        return (i5 << 11) | (i5 >>> 21);
    }

    private static void e(String str, byte[] bArr) {
        m.put(a0b.j(str), bArr);
    }
    ...
    private int[] g(boolean z, byte[] bArr) {
        this.b = z;
        if (bArr.length == 32) {
            int[] iArr = new int[8];
    ...
    public static byte[] h(String str) {
        byte[] bArr = (byte[]) m.get(a0b.j(str));
        if (bArr != null) {
            return tr.h(bArr);
        }
