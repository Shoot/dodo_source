...
public final class fo4 implements ye6 {
    ...
    public fo4(String str, String str2, String str3, km8 km8Var, String str4, String str5, re6 re6Var, kl8 kl8Var, String str6, boolean z, qd6.a aVar, Collection<ProductPromoAction> collection, hn6 hn6Var, l18 l18Var, int i, hn6 hn6Var2, boolean z2, long j, hf6 hf6Var) {
    ...
    public boolean equals(Object obj) {
        ...
        fo4 fo4Var = (fo4) obj;
        if (z65.c(this.a, fo4Var.a) && z65.c(this.b, fo4Var.b) && z65.c(this.c, fo4Var.c) && z65.c(this.d, fo4Var.d) && z65.c(this.e, fo4Var.e) && z65.c(this.f, fo4Var.f) && this.g == fo4Var.g && this.h == fo4Var.h && z65.c(this.i, fo4Var.i) && this.j == fo4Var.j && z65.c(this.k, fo4Var.k) && z65.c(this.l, fo4Var.l) && z65.c(this.m, fo4Var.m) && z65.c(this.n, fo4Var.n) && this.o == fo4Var.o && z65.c(this.p, fo4Var.p) && this.q == fo4Var.q && this.r == fo4Var.r && this.s == fo4Var.s) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        long j = this.r;
        hf6 hf6Var = this.s;
        return "HeroMenuItemVO(menuItemId=" + str + ", menuCategoryId=" + str2 + ", name=" + str3 + ", size=" + km8Var + ", description=" + str4 + ", compositeDescription=" + str5 + ", menuItemType=" + re6Var + ", productCategory=" + kl8Var + ", imageUrl=" + str6 + ", isStopped=" + z + ", addingToCartFromMenu=" + aVar + ", promoActions=" + collection + ", price=" + hn6Var + ", personalPrice=" + l18Var + ", variationsCount=" + i + ", rawPrice=" + hn6Var2 + ", showDiscountBadge=" + z2 + ", discountEndTime=" + j + ", menuItemVersion=" + hf6Var + ")";
    }
