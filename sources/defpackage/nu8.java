...
public class nu8 extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public final Key engineTranslateKey(Key key) throws InvalidKeyException {
        if (!(key instanceof o50) && !(key instanceof p50)) {
