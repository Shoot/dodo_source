...
public final class lk6 extends vw1 {
    ...
    /* compiled from: MindboxNotification.kt */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\n\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\n\u0010\u000bR\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004R\u0014\u0010\u0006\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0006\u0010\u0004R\u0014\u0010\u0007\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0007\u0010\u0004R\u0014\u0010\b\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\b\u0010\u0004R\u0014\u0010\t\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\t\u0010\u0004¨\u0006\f"}, d2 = {"Llk6$a;", "", "", "CLICK_URL_KEY", "Ljava/lang/String;", "IMAGE_URL_KEY", "MESSAGE_KEY", "PAYLOAD_KEY", "TITLE_KEY", "UNIQUE_KEY_KEY", "<init>", "()V", "app_prodRelease"}, k = 1, mv = {1, 9, 0})
    /* renamed from: lk6$a */
    /* loaded from: classes3.dex */
    ...
    public lk6(u27 u27Var, gc gcVar) {
    ...
    private final void k(Context context, NotificationManager notificationManager, Bitmap bitmap) {
        ...
        v27 v27Var = v27.f;
        PendingIntent a2 = new to9(context).a(d2.c(v27Var.getValue()).b("mindbox_build_extra", j()).b("mindbox_message_extra", f()).b("mindbox_payload_extra", h()).a());
        ...
        this.b.a(new rs8.c(d(), rs8.a.i(context), i(), f(), v27Var, null, null, null, 224, null));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void l(lk6 lk6Var, Context context, NotificationManager notificationManager, Bitmap bitmap) {
        z65.h(lk6Var, "this$0");
        z65.h(context, "$context");
        z65.h(notificationManager, "$notificationManager");
        lk6Var.k(context, notificationManager, bitmap);
    }
    ...
    public void b(final Context context, final NotificationManager notificationManager) {
        ...
        if (e().length() == 0) {
            ...
            new p27(context).a(e(), new tr5() { // from class: kk6
                @Override // defpackage.tr5
                public final void a(Bitmap bitmap) {
                    lk6.l(lk6.this, context, notificationManager, bitmap);
                }
            });
        }
    }
