...
public final class y14 {
    ...
    @nn2(c = "androidx.compose.foundation.interaction.FocusInteractionKt$collectIsFocusedAsState$1$1", f = "FocusInteraction.kt", l = {69}, m = "invokeSuspend")
    /* renamed from: y14$a */
    /* loaded from: classes.dex */
    static final class a extends f3b implements Function2<qx1, cv1<? super Unit>, Object> {
        ...
        /* loaded from: classes.dex */
        public static final class C0749a implements pz3<h65> {
            final /* synthetic */ List<w14> a;
            final /* synthetic */ er6<Boolean> b;

            C0749a(List<w14> list, er6<Boolean> er6Var) {
                this.a = list;
                this.b = er6Var;
            }
            ...
            public final Object emit(h65 h65Var, cv1<? super Unit> cv1Var) {
                if (h65Var instanceof w14) {
                    this.a.add(h65Var);
                } else if (h65Var instanceof x14) {
                    this.a.remove(((x14) h65Var).a());
                }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i != 0) {
                ...
                oz3<h65> b = this.b.b();
                C0749a c0749a = new C0749a(arrayList, this.c);
                this.a = 1;
                if (b.collect(c0749a, this) == d) {
                    return d;
                }
            }
            return Unit.a;
    ...
    public static final cua<Boolean> a(i65 i65Var, qn1 qn1Var, int i) {
        ...
        qn1Var.w(-1805515472);
        if (tn1.K()) {
            tn1.V(-1805515472, i, -1, "androidx.compose.foundation.interaction.collectIsFocusedAsState (FocusInteraction.kt:64)");
        }
        qn1Var.w(-492369756);
        Object x = qn1Var.x();
        qn1.a aVar = qn1.a;
