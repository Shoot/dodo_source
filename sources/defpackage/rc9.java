...
public final class rc9 implements ye6 {
    ...
    public rc9(String str, String str2, String str3, km8 km8Var, String str4, String str5, re6 re6Var, kl8 kl8Var, String str6, boolean z, qd6.a aVar, Collection<ProductPromoAction> collection, hn6 hn6Var, l18 l18Var, int i, hn6 hn6Var2, boolean z2, long j, hf6 hf6Var) {
    ...
    public boolean equals(Object obj) {
        ...
        rc9 rc9Var = (rc9) obj;
        if (z65.c(this.a, rc9Var.a) && z65.c(this.b, rc9Var.b) && z65.c(this.c, rc9Var.c) && z65.c(this.d, rc9Var.d) && z65.c(this.e, rc9Var.e) && z65.c(this.f, rc9Var.f) && this.g == rc9Var.g && this.h == rc9Var.h && z65.c(this.i, rc9Var.i) && this.j == rc9Var.j && z65.c(this.k, rc9Var.k) && z65.c(this.l, rc9Var.l) && z65.c(this.m, rc9Var.m) && z65.c(this.n, rc9Var.n) && this.o == rc9Var.o && z65.c(this.p, rc9Var.p) && this.q == rc9Var.q && this.r == rc9Var.r && this.s == rc9Var.s) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        long j = this.r;
        hf6 hf6Var = this.s;
        return "RegularMenuItemVO(menuItemId=" + str + ", menuCategoryId=" + str2 + ", name=" + str3 + ", size=" + km8Var + ", description=" + str4 + ", compositeDescription=" + str5 + ", menuItemType=" + re6Var + ", productCategory=" + kl8Var + ", imageUrl=" + str6 + ", isStopped=" + z + ", addingToCartFromMenu=" + aVar + ", promoActions=" + collection + ", price=" + hn6Var + ", personalPrice=" + l18Var + ", variationsCount=" + i + ", rawPrice=" + hn6Var2 + ", showDiscountBadge=" + z2 + ", discountEndTime=" + j + ", menuItemVersion=" + hf6Var + ")";
    }
    ...
    public /* synthetic */ rc9(String str, String str2, String str3, km8 km8Var, String str4, String str5, re6 re6Var, kl8 kl8Var, String str6, boolean z, qd6.a aVar, Collection collection, hn6 hn6Var, l18 l18Var, int i, hn6 hn6Var2, boolean z2, long j, hf6 hf6Var, int i2, DefaultConstructorMarker defaultConstructorMarker) {
