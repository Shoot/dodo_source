...
public class bz9 extends ea3.c {
    ...
    class a extends g1 {
        ...
        private jb3 d(int[] iArr, int[] iArr2) {
            return bz9.this.i(new dz9(iArr), new dz9(iArr2), bz9.k);
        }
    ...
    public bz9() {
        super(j);
        this.i = new ez9(this, null, null);
        this.b = m(new BigInteger(1, b.b("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70")));
        this.c = m(new BigInteger(1, b.b("B4E134D3FB59EB8BAB57274904664D5AF50388BA")));
        this.d = new BigInteger(1, b.b("0100000000000000000000351EE786A818F3A1A16B"));
    ...
    public jb3 h(na3 na3Var, na3 na3Var2) {
        return new ez9(this, na3Var, na3Var2);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // defpackage.ea3
    public jb3 i(na3 na3Var, na3 na3Var2, na3[] na3VarArr) {
        return new ez9(this, na3Var, na3Var2, na3VarArr);
    }
