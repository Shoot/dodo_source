...
public final class iu implements ye6 {
    ...
    public iu(String str, String str2, String str3, km8 km8Var, String str4, String str5, re6 re6Var, kl8 kl8Var, String str6, boolean z, qd6.a aVar, Collection<ProductPromoAction> collection, hn6 hn6Var, l18 l18Var, int i, hn6 hn6Var2, boolean z2, long j, hf6 hf6Var) {
    ...
    public boolean equals(Object obj) {
        ...
        iu iuVar = (iu) obj;
        if (z65.c(this.a, iuVar.a) && z65.c(this.b, iuVar.b) && z65.c(this.c, iuVar.c) && z65.c(this.d, iuVar.d) && z65.c(this.e, iuVar.e) && z65.c(this.f, iuVar.f) && this.g == iuVar.g && this.h == iuVar.h && z65.c(this.i, iuVar.i) && this.j == iuVar.j && z65.c(this.k, iuVar.k) && z65.c(this.l, iuVar.l) && z65.c(this.m, iuVar.m) && z65.c(this.n, iuVar.n) && this.o == iuVar.o && z65.c(this.p, iuVar.p) && this.q == iuVar.q && this.r == iuVar.r && this.s == iuVar.s) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        long j = this.r;
        hf6 hf6Var = this.s;
        return "AssistantMenuItemVO(menuItemId=" + str + ", menuCategoryId=" + str2 + ", name=" + str3 + ", size=" + km8Var + ", description=" + str4 + ", compositeDescription=" + str5 + ", menuItemType=" + re6Var + ", productCategory=" + kl8Var + ", imageUrl=" + str6 + ", isStopped=" + z + ", addingToCartFromMenu=" + aVar + ", promoActions=" + collection + ", price=" + hn6Var + ", personalPrice=" + l18Var + ", variationsCount=" + i + ", rawPrice=" + hn6Var2 + ", showDiscountBadge=" + z2 + ", discountEndTime=" + j + ", menuItemVersion=" + hf6Var + ")";
    }
    ...
    public /* synthetic */ iu(String str, String str2, String str3, km8 km8Var, String str4, String str5, re6 re6Var, kl8 kl8Var, String str6, boolean z, qd6.a aVar, Collection collection, hn6 hn6Var, l18 l18Var, int i, hn6 hn6Var2, boolean z2, long j, hf6 hf6Var, int i2, DefaultConstructorMarker defaultConstructorMarker) {
