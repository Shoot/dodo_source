...
public final class dq8 {
    ...
    public dq8(f8c f8cVar, WorkflowApi workflowApi, dua duaVar) {
    ...
    public final op8 a(String str) {
        z65.h(str, "promoCodeValue");
        try {
            CartEntity cart = this.c.d(this.b.setPromoCode(new SetPromoCodeRequestDto(this.a.b(), str))).getCart();
            z65.e(cart);
            return jq8.a(cart.getPromoCode());
        } catch (Exception e) {
            this.d.warn("Failed to apply promo code. ", (Throwable) e);
            if ((e instanceof HttpException) && ((HttpException) e).code() == 400) {
                return new op8(str, 0, "", "", "", "", eq8.e);
            }
            return new op8(str, 0, "", "", "", "", eq8.d);
        }
    }

    public final void b() {
        this.c.d(this.b.resetPromoCode(this.a.b()));
    }
}
