...
public final class ij8 {
    ...
    @nn2(c = "androidx.compose.foundation.interaction.PressInteractionKt$collectIsPressedAsState$1$1", f = "PressInteraction.kt", l = {88}, m = "invokeSuspend")
    /* renamed from: ij8$a */
    /* loaded from: classes.dex */
    static final class a extends f3b implements Function2<qx1, cv1<? super Unit>, Object> {
        ...
        /* loaded from: classes.dex */
        public static final class C0357a implements pz3<h65> {
            final /* synthetic */ List<gj8> a;
            final /* synthetic */ er6<Boolean> b;

            C0357a(List<gj8> list, er6<Boolean> er6Var) {
                this.a = list;
                this.b = er6Var;
            }
            ...
            public final Object emit(h65 h65Var, cv1<? super Unit> cv1Var) {
                if (h65Var instanceof gj8) {
                    this.a.add(h65Var);
                } else if (h65Var instanceof hj8) {
                    this.a.remove(((hj8) h65Var).a());
                } else if (h65Var instanceof fj8) {
                    this.a.remove(((fj8) h65Var).a());
                }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i != 0) {
                ...
                oz3<h65> b = this.b.b();
                C0357a c0357a = new C0357a(arrayList, this.c);
                this.a = 1;
    ...
    public static final cua<Boolean> a(i65 i65Var, qn1 qn1Var, int i) {
        ...
        qn1Var.w(-1692965168);
        if (tn1.K()) {
            tn1.V(-1692965168, i, -1, "androidx.compose.foundation.interaction.collectIsPressedAsState (PressInteraction.kt:83)");
        }
        qn1Var.w(-492369756);
        Object x = qn1Var.x();
        qn1.a aVar = qn1.a;
