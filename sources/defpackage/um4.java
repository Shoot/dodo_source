...
public class um4 extends vm4 {
    ...
    private int j(byte[] bArr, byte[] bArr2, int i) {
        ...
        bArr3[0] = vm4.a(bArr3[0], d[0]);
        bArr3[1] = vm4.a(bArr3[1], d[1]);
        bArr3[2] = vm4.a(bArr3[2], d[2]);
        bArr3[3] = vm4.a(bArr3[3], d[3]);
        bArr3[0] = vm4.a(bArr3[0], d[4]);
        bArr3[1] = vm4.a(bArr3[1], d[5]);
        bArr3[2] = vm4.a(bArr3[2], d[6]);
        bArr3[3] = vm4.a(bArr3[3], d[7]);
        k(bArr3, bArr4);
        bArr3[0] = vm4.a(bArr4[0], d[8]);
        bArr3[1] = vm4.a(bArr4[1], d[9]);
        bArr3[2] = vm4.a(bArr4[2], d[10]);
        bArr3[3] = vm4.a(bArr4[3], d[11]);
        bArr3[0] = vm4.a(bArr3[0], d[12]);
        bArr3[1] = vm4.a(bArr3[1], d[13]);
        bArr3[2] = vm4.a(bArr3[2], d[14]);
        bArr3[3] = vm4.a(bArr3[3], d[15]);
        k(bArr3, bArr4);
        bArr3[0] = vm4.a(bArr4[0], d[16]);
        bArr3[1] = vm4.a(bArr4[1], d[17]);
        bArr3[2] = vm4.a(bArr4[2], d[18]);
        bArr3[3] = vm4.a(bArr4[3], d[19]);
        bArr3[0] = vm4.a(bArr3[0], d[20]);
        bArr3[1] = vm4.a(bArr3[1], d[21]);
        bArr3[2] = vm4.a(bArr3[2], d[22]);
        bArr3[3] = vm4.a(bArr3[3], d[23]);
        k(bArr3, bArr4);
        bArr3[0] = vm4.a(bArr4[0], d[24]);
        bArr3[1] = vm4.a(bArr4[1], d[25]);
        bArr3[2] = vm4.a(bArr4[2], d[26]);
        bArr3[3] = vm4.a(bArr4[3], d[27]);
        bArr3[0] = vm4.a(bArr3[0], d[28]);
        bArr3[1] = vm4.a(bArr3[1], d[29]);
        bArr3[2] = vm4.a(bArr3[2], d[30]);
        bArr3[3] = vm4.a(bArr3[3], d[31]);
        k(bArr3, bArr4);
        bArr3[0] = vm4.a(bArr4[0], d[32]);
        bArr3[1] = vm4.a(bArr4[1], d[33]);
        bArr3[2] = vm4.a(bArr4[2], d[34]);
        bArr3[3] = vm4.a(bArr4[3], d[35]);
        bArr3[0] = vm4.a(bArr3[0], d[36]);
        bArr3[1] = vm4.a(bArr3[1], d[37]);
        bArr3[2] = vm4.a(bArr3[2], d[38]);
        bArr3[3] = vm4.a(bArr3[3], d[39]);
        k(bArr3, bArr4);
        bArr3[0] = vm4.h(bArr4[0], bArr, 0);
        bArr3[1] = vm4.h(bArr4[1], bArr, 16);
        bArr3[2] = vm4.h(bArr4[2], bArr, 32);
        bArr3[3] = vm4.h(bArr4[3], bArr, 48);
    ...
    public um4(um4 um4Var) {
        this.b = tr.h(um4Var.b);
        this.c = um4Var.c;
    }
