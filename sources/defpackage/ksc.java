...
public enum ksc {
    ...
    private static final Map<Integer, ksc> B5 = new HashMap();
    private final int a;

    static {
        ksc[] values;
        for (ksc kscVar : values()) {
            B5.put(Integer.valueOf(kscVar.a), kscVar);
        }
    }
    ...
    public static ksc a(int i) {
        return B5.get(Integer.valueOf(i));
    }
