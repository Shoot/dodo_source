...
public class c0 implements xc0 {
    private static final byte[][] b = {b.b("517cc1b727220a94fe13abe8fa9a6ee0"), b.b("6db14acc9e21c820ff28b1d5ef5de2b0"), b.b("db92371d2126e9700324977504e8c90e")};
    ...
    protected static void d(byte[] bArr, byte[] bArr2) {
        o(bArr, bArr2);
        k(bArr);
        c(bArr);
    }

    protected static void e(byte[] bArr, byte[] bArr2) {
        o(bArr, bArr2);
        j(bArr);
        c(bArr);
    }
    ...
    protected static byte h(byte b2) {
        return e[b2 & 255];
    }

    protected static byte i(byte b2) {
        return f[b2 & 255];
    }

    protected static void j(byte[] bArr) {
        bArr[0] = f(bArr[0]);
        bArr[1] = g(bArr[1]);
        bArr[2] = h(bArr[2]);
        bArr[3] = i(bArr[3]);
    ...
    protected static void k(byte[] bArr) {
        bArr[0] = h(bArr[0]);
        bArr[1] = i(bArr[1]);
        bArr[2] = f(bArr[2]);
        bArr[3] = g(bArr[3]);
    ...
    protected static byte[][] l(boolean z, byte[] bArr) {
        ...
        if (length >= 16 && length <= 32 && (length & 7) == 0) {
            ...
            m(bArr12[0], bArr8, bArr9, 19);
            m(bArr12[1], bArr9, bArr10, 19);
            m(bArr12[2], bArr10, bArr11, 19);
            m(bArr12[3], bArr11, bArr8, 19);
            m(bArr12[4], bArr8, bArr9, 31);
            m(bArr12[5], bArr9, bArr10, 31);
            m(bArr12[6], bArr10, bArr11, 31);
            m(bArr12[7], bArr11, bArr8, 31);
            m(bArr12[8], bArr8, bArr9, 67);
            m(bArr12[9], bArr9, bArr10, 67);
            m(bArr12[10], bArr10, bArr11, 67);
            m(bArr12[11], bArr11, bArr8, 67);
            m(bArr12[12], bArr8, bArr9, 97);
            if (i4 > 12) {
                m(bArr12[13], bArr9, bArr10, 97);
                m(bArr12[14], bArr10, bArr11, 97);
                if (i4 > 14) {
                    m(bArr12[15], bArr11, bArr8, 97);
                    m(bArr12[16], bArr8, bArr9, 109);
                }
            }
            if (!z) {
                n(bArr12);
    ...
    protected static void m(byte[] bArr, byte[] bArr2, byte[] bArr3, int i) {
        int i2 = i >>> 3;
        int i3 = i & 7;
        int i4 = 8 - i3;
    ...
    protected static void n(byte[][] bArr) {
        int length = bArr.length;
        int i = length / 2;
        int i2 = length - 1;
    ...
    public void init(boolean z, v71 v71Var) throws IllegalArgumentException {
        if (v71Var instanceof lf5) {
            this.a = l(z, ((lf5) v71Var).a());
            return;
        }
        throw new IllegalArgumentException("invalid parameter passed to ARIA init - " + v71Var.getClass().getName());
    }
