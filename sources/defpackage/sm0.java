...
public class sm0 implements xc0 {
    ...
    private void d(int[] iArr, int[] iArr2, int i2) {
        ...
        iArr[2] = iArr[2] ^ i9;
        int l = (l(i7, 8) ^ i9) ^ iArr[3];
        iArr[3] = l;
        int i10 = iArr[2] ^ iArr2[i2 + 2];
        int i11 = iArr6[(i10 >>> 24) & 255] ^ ((iArr3[i10 & 255] ^ iArr4[(i10 >>> 8) & 255]) ^ iArr5[(i10 >>> 16) & 255]);
        int i12 = iArr2[i2 + 3] ^ l;
        int i13 = (iArr5[(i12 >>> 24) & 255] ^ ((iArr6[i12 & 255] ^ iArr3[(i12 >>> 8) & 255]) ^ iArr4[(i12 >>> 16) & 255])) ^ i11;
        iArr[0] = iArr[0] ^ i13;
        iArr[1] = (i13 ^ l(i11, 8)) ^ iArr[1];
    }

    private void e(int[] iArr, int[] iArr2, int i2) {
        int i3 = iArr[1] ^ i(iArr[0] & iArr2[i2], 1);
        iArr[1] = i3;
        iArr[0] = (i3 | iArr2[i2 + 1]) ^ iArr[0];
        int i4 = iArr[2];
        int i5 = iArr2[i2 + 3];
        int i6 = iArr[3];
        int i7 = i4 ^ (i5 | i6);
        iArr[2] = i7;
        iArr[3] = i(iArr2[i2 + 2] & i7, 1) ^ i6;
    }

    private static void f(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 2;
        int i6 = i3 + 1;
        int i7 = 32 - i2;
    ...
    private static void g(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 2;
        int i6 = i3 + 1;
        int i7 = i2 - 32;
        int i8 = i3 + 2;
    ...
    private int j(byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        h(i6, bArr2, i3);
        h(this.f[3], bArr2, i3 + 4);
        h(this.f[0], bArr2, i3 + 8);
        h(this.f[1], bArr2, i3 + 12);
        return 16;
    }

    private int k(byte[] bArr, int i2, byte[] bArr2, int i3) {
        for (int i4 = 0; i4 < 4; i4++) {
            this.f[i4] = c(bArr, (i4 * 4) + i2);
            int[] iArr = this.f;
            iArr[i4] = iArr[i4] ^ this.d[i4];
    ...
    private static void m(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i3 + 1;
        int i6 = 32 - i2;
    ...
    private static void n(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i3 + 1;
        int i6 = i2 - 32;
        int i7 = i3 + 2;
        int i8 = 64 - i2;
    ...
    private void o(boolean z, byte[] bArr) {
        int[] iArr = new int[8];
        int[] iArr2 = new int[4];
        int[] iArr3 = new int[4];
        int[] iArr4 = new int[4];
        ...
        if (this.b) {
            ...
            if (z) {
                ...
                iArr5[2] = iArr[2];
                iArr5[3] = iArr[3];
                m(15, iArr, 0, this.c, 4);
                m(30, iArr, 0, this.c, 12);
                m(15, iArr, 0, iArr4, 0);
                int[] iArr6 = this.c;
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                m(17, iArr, 0, this.e, 4);
                m(17, iArr, 0, this.c, 24);
                m(17, iArr, 0, this.c, 32);
                int[] iArr7 = this.c;
                iArr7[0] = iArr2[0];
                iArr7[1] = iArr2[1];
                iArr7[2] = iArr2[2];
                iArr7[3] = iArr2[3];
                m(15, iArr2, 0, iArr7, 8);
                m(15, iArr2, 0, this.e, 0);
                m(15, iArr2, 0, iArr4, 0);
                int[] iArr8 = this.c;
                iArr8[16] = iArr4[0];
                iArr8[17] = iArr4[1];
                m(15, iArr2, 0, iArr8, 20);
                n(34, iArr2, 0, this.c, 28);
                m(17, iArr2, 0, this.d, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            iArr5[6] = iArr[2];
            iArr5[7] = iArr[3];
            f(15, iArr, 0, this.c, 28);
            f(30, iArr, 0, this.c, 20);
            f(15, iArr, 0, iArr4, 0);
            int[] iArr9 = this.c;
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            f(17, iArr, 0, this.e, 0);
            f(17, iArr, 0, this.c, 8);
            f(17, iArr, 0, this.c, 0);
            int[] iArr10 = this.c;
            iArr10[34] = iArr2[0];
            iArr10[35] = iArr2[1];
            iArr10[32] = iArr2[2];
            ...
            f(15, iArr2, 0, this.e, 4);
            f(15, iArr2, 0, iArr4, 0);
            int[] iArr11 = this.c;
            iArr11[18] = iArr4[2];
            iArr11[19] = iArr4[3];
            f(15, iArr2, 0, iArr11, 12);
            g(34, iArr2, 0, this.c, 4);
            m(17, iArr2, 0, this.d, 0);
            return;
        }
        for (int i4 = 0; i4 < 4; i4++) {
        ...
        if (z) {
            ...
            iArr12[2] = iArr[2];
            iArr12[3] = iArr[3];
            n(45, iArr, 0, this.c, 16);
            m(15, iArr, 0, this.e, 4);
            m(17, iArr, 0, this.c, 32);
            n(34, iArr, 0, this.c, 44);
            m(15, iArr, 4, this.c, 4);
            m(15, iArr, 4, this.e, 0);
            m(30, iArr, 4, this.c, 24);
            n(34, iArr, 4, this.c, 36);
            m(15, iArr2, 0, this.c, 8);
            m(30, iArr2, 0, this.c, 20);
            int[] iArr13 = this.e;
            iArr13[8] = iArr2[1];
            iArr13[9] = iArr2[2];
            iArr13[10] = iArr2[3];
            iArr13[11] = iArr2[0];
            n(49, iArr2, 0, this.c, 40);
            int[] iArr14 = this.c;
            iArr14[0] = iArr3[0];
            iArr14[1] = iArr3[1];
            iArr14[2] = iArr3[2];
            iArr14[3] = iArr3[3];
            m(30, iArr3, 0, iArr14, 12);
            m(30, iArr3, 0, this.c, 28);
            n(51, iArr3, 0, this.d, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        iArr12[6] = iArr[2];
        iArr12[7] = iArr[3];
        g(45, iArr, 0, this.c, 28);
        f(15, iArr, 0, this.e, 4);
        f(17, iArr, 0, this.c, 12);
        g(34, iArr, 0, this.c, 0);
        f(15, iArr, 4, this.c, 40);
        f(15, iArr, 4, this.e, 8);
        f(30, iArr, 4, this.c, 20);
        g(34, iArr, 4, this.c, 8);
        f(15, iArr2, 0, this.c, 36);
        f(30, iArr2, 0, this.c, 24);
        int[] iArr15 = this.e;
        iArr15[2] = iArr2[1];
        iArr15[3] = iArr2[2];
        iArr15[0] = iArr2[3];
        iArr15[1] = iArr2[0];
        g(49, iArr2, 0, this.c, 4);
        int[] iArr16 = this.c;
        iArr16[46] = iArr3[0];
        iArr16[47] = iArr3[1];
        iArr16[44] = iArr3[2];
        ...
        f(30, iArr3, 0, this.c, 16);
        n(51, iArr3, 0, this.d, 0);
    }
        ...
        if (this.a) {
            if (i2 + 16 <= bArr.length) {
                if (i3 + 16 <= bArr2.length) {
                    if (this.b) {
                        return j(bArr, i2, bArr2, i3);
                    }
                    return k(bArr, i2, bArr2, i3);
                }
