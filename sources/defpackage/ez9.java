...
public class ez9 extends jb3.c {
    /* JADX INFO: Access modifiers changed from: package-private */
    public ez9(ea3 ea3Var, na3 na3Var, na3 na3Var2) {
    ...
    public jb3 J() {
        ...
        cz9.o(dz9Var2.g, iArr, d);
        cz9.a(dz9Var2.g, iArr, d2);
        cz9.f(d2, d, d2);
        cz9.l(vs6.b(d2, d2, d2), d2);
        cz9.f(d3, dz9Var2.g, d3);
        cz9.l(et6.M(5, d3, 2, 0), d3);
        cz9.l(et6.N(5, d4, 3, 0, d), d);
        dz9 dz9Var4 = new dz9(d4);
        cz9.m(d2, dz9Var4.g);
        int[] iArr2 = dz9Var4.g;
        cz9.o(iArr2, d3, iArr2);
        int[] iArr3 = dz9Var4.g;
        cz9.o(iArr3, d3, iArr3);
        dz9 dz9Var5 = new dz9(d3);
        cz9.o(d3, dz9Var4.g, dz9Var5.g);
        int[] iArr4 = dz9Var5.g;
        cz9.f(iArr4, d2, iArr4);
        int[] iArr5 = dz9Var5.g;
        cz9.o(iArr5, d, iArr5);
        dz9 dz9Var6 = new dz9(d2);
        cz9.p(dz9Var.g, dz9Var6.g);
        if (!h) {
            int[] iArr6 = dz9Var6.g;
            cz9.f(iArr6, dz9Var3.g, iArr6);
        }
        return new ez9(i, dz9Var4, dz9Var5, new na3[]{dz9Var6});
    }
    ...
    public jb3 a(jb3 jb3Var) {
        ...
        return new ez9(i, dz9Var7, dz9Var8, new na3[]{dz9Var9});
    }

    @Override // defpackage.jb3
    protected jb3 d() {
        return new ez9(null, f(), g());
    }
    ...
    public jb3 z() {
        ...
        return new ez9(this.a, this.b, this.c.m(), this.d);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public ez9(ea3 ea3Var, na3 na3Var, na3 na3Var2, na3[] na3VarArr) {
