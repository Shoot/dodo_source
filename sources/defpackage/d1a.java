...
public class d1a extends ea3.b {
    ...
    class a extends g1 {
        ...
        private jb3 d(long[] jArr, long[] jArr2) {
            return d1a.this.i(new y0a(jArr), new y0a(jArr2), d1a.k);
        }
    ...
    public d1a() {
        super(163, 3, 6, 7);
        this.j = new e1a(this, null, null);
        this.b = m(BigInteger.valueOf(1L));
        this.c = m(new BigInteger(1, b.b("020A601907B8C953CA1481EB10512F78744A3205FD")));
        this.d = new BigInteger(1, b.b("040000000000000000000292FE77E70C12A4234C33"));
    ...
    public jb3 h(na3 na3Var, na3 na3Var2) {
        return new e1a(this, na3Var, na3Var2);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // defpackage.ea3
    public jb3 i(na3 na3Var, na3 na3Var2, na3[] na3VarArr) {
        return new e1a(this, na3Var, na3Var2, na3VarArr);
    }
